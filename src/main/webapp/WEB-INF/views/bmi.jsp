...
<html lang="en-IN">
	...
	<body>
		...
		<header>
			...
			<div class="panel panel-default col-sm-8"><h3 class="text-center" style="color:#000"><strong>BMI Calculator</strong></h3></div> 
			<div class="col-sm-2"></div>
		</header>
		<div class="col-sm-12">
		...
		<form class="form-horizontal" action="bmiCalc" method="post">
			<div class="form-group">
				...
				<div class="input-group col-sm-8">
					...
					<input type="number" name="weight" value="${weight}" placeholder="Weight(in kgs.)" min="40" max="200" class="form-control" id="weight" required/>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="input-group col-sm-8">
					<span class="input-group-addon"><i class="glyphicon glyphicon-user" aria-hidden="true"></i></span>
					<input type="number" name="height"  value="${height}" placeholder="Height(in cms.)" min="120" max="250" class="form-control" id="height" required/>
				</div>
			</div>
			<div class="form-group">
